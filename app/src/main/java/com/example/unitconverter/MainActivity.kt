...
fun UnitConverter() {
    ...
    fun convertUnits() {
        ...
        val result =
            (inputValueDouble * conversionFactor.value * 100.00 / oConversionFactor.value).roundToInt() / 100.0
    ...
    Column(
        ...
        Text(text = "Result: ${outputValue} ${outputUnits}", style = MaterialTheme.typography.headlineMedium)
    }
}
